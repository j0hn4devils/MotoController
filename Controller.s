...
;						 SPI
SPI_BASE	EQU	0x40076000		;Base for SPI0
SPI_BAUD	EQU 	(SPI_BASE + 0x01)	;Base for Baud register
SPI_C2		EQU 	(SPI_BASE + 0x02)	;Base for C2 register
SPI_C1		EQU 	(SPI_BASE + 0x03)	;Base for C1 register
SPI_DL		EQU	(SPI_BASE + 0x06)	;Base for DL register
SPI_DH		EQU	(SPI_BASE + 0x07)	;Base for DH register
SPI_C3		EQU	(SPI_BASE + 0x0B)	;Base for C3  register
