...
extern void sequentialPattern(int NumLED,volatile char *TruthCondition, char Speed);
extern void reverseSequentialPattern(int NumLED, volatile char *TruthCondition, char Speed);
